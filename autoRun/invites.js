...
//             welcomeChannel.send(`Welcome <@!${member.id}> You were invited by **${invite.inviter.username}**!`);
            
//         } else if(type === 'vanity'){

//             welcomeChannel.send(`Welcome <@!${member.id}>! You joined using a custom invite!`);
